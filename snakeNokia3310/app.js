document.addEventListener('DOMContentLoaded', () => {
  ...
  let currentSnake = [
    2, 1, 0,
  ] /*so the div in our grid being 2 (or the HEAD), and 0 being the end (or the TAIL, with all 1's being the body from now on)*/
  ...
  const moveOutcomes = () => {
    ...
    if (
      ...
      squares[currentSnake[0] + direction].classList.contains('snake') // if snake into itself
    ) {
